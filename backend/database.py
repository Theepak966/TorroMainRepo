...
try:
    ...
    DB_NAME = os.getenv("DB_NAME", "torroforairflow")
...
engine = create_engine(
    ...
    connect_args={
        "connect_timeout": 10,
        "read_timeout": 180,   # OPTIMIZATION 7: Increased from 120 to 180 seconds
        "write_timeout": 240   # OPTIMIZATION 7: Increased from 180 to 240 seconds
    },
